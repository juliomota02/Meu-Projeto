function getProjects() {
  const urlGitHub = "https://api.github.com/users/1diegololXD/repos"; // Inserir o nome de usuário do seu github
...
function showProjects(data) {
  ...
  data.forEach((repo) => {
    ...
    a.href = repo["https://github.com/1diegololXD?tab=repositories"]; // Link para o repositório no GitHub
    a.target = "_blank";
